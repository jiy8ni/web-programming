...
const app = {
    ...
    li.appendChild(toggleBtn); //li엘리먼트에 toggleBtn 엘리먼트 추가
...
init() {
    ...
    this.form.addEventListener("submit", (event) => {
        ...
        const title = this.titleInput.ariaValueMax; // 입력된 할 일 제목
        const dueDate = this.dueDateInput.ariaValueMax; // 입력된 마감 기한 
